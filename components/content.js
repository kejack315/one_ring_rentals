                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="main col-sm-8">
                            ...
                            <div className="center"><a href="#" className="btn btn-default-color">View All News</a>
                            </div>
                        </div>
                                ...
                                <ul className="latest-news">
                                    <li className="col-md-12">
                                        <div className="image">
                                            ...
                                            <img alt="" src="http://placehold.it/100x100"></img>
                                        </div>
                            ...
                            <div className="col-sm-12">
                                ...
                                <ul className="activity">
                                    ...
                                    <li className="col-lg-12">
                                        <a href="#"><img src="http://placehold.it/70x70" alt=""/></a>
                                        <div className="info">
                                            <h5>Ingo Schoomer asked a question about <a href="#">The Mistake by the
                                                Lake</a></h5>
